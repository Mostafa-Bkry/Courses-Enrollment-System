    ...
    internal static class StudentsSeed
    {
        public static List<Student> InitialStudents { get; set; } = new List<Student>()
        {
            ...
            new Student() 
            {
                ...
                BirthDate = new DateTime(1950, 5, 3), NID = "56781234910111", 
...

            {
                ...
                BirthDate = new DateTime(1999, 2, 2), NID = "12678913450111", 
...

            {
                ...
                BirthDate = new DateTime(2005, 3, 2), NID = "12340115678911", 
...

            {
                ...
                BirthDate = new DateTime(2001, 12, 11), NID = "17891012345611", 
...

            {
                ...
                BirthDate = new DateTime(2002, 1, 11), NID = "12891013456711", 
...

            {
                ...
                BirthDate = new DateTime(1994, 2, 11), NID = "11011123456789", 
